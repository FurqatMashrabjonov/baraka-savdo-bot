...
class Dashboard extends Component
{
    ...
    {
        // Mock data - return 6 USD per selected parcel for testing
        return count($this->selectedParcels) * 2.5; // 2.5 kg per parcel
    }

    public function getTotalCost()
    {
        // Mock data - return 6 USD per selected parcel for testing
        return count($this->selectedParcels) * 6; // $6 per parcel
    }
