...
return [
    ...
    'all_parcels' => 'Все',
    'created_at' => 'Создано',
    'bot_entry_date' => 'Дата ввода в бота',
    'client_id' => 'ID клиента',
    'search_by_track_number' => 'Поиск по трек-номеру',
    'search_by_client_id' => 'Поиск по ID клиента',
    'created_from' => 'Создано с',
    'created_until' => 'Создано до',
    'track_number_filter' => 'Трек-номер: ',
    'client_id_filter' => 'ID клиента: ',
    'from_filter' => 'С: ',
    'until_filter' => 'До: ',
